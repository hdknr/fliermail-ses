# **fliermail-ses** Installation Instructions

This section contains information about 
how to download and install **fliermail-ses** in your system. 
...
inside the ** fliermail-ses ** distribution package. 
...
URL is https://github.org/hdknr/fliermail-ses


## Install

To install **fliermail-ses** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.org/hdknr/fliermail-ses

The above command will install the latest development release of **fliermail-ses**.
